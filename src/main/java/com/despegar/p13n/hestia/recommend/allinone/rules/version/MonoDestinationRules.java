...
public class MonoDestinationRules {

    private ItemRuleEngine itemRuleEngine;

    public MonoDestinationRules(ItemRuleEngine itemRuleEngine) {
    ...
    private void buildBuyHome() {
        ...
        this.itemRuleEngine.addForMonoDestination(rule, hrc);
    }
    ...
    private void buildBuyCruises() {
        HomeRuleContent hrc = HomeRuleBuilder.create()//
            .withOffers(IdFunction.BUY_DESTINATION, ProductFuncCode.CRUISES)//
            .withRow1(IdFunction.BUY_DESTINATION.index(1), ProductFuncCode.PRODUCTS)//
            .withRow2(IdFunction.BUY_DESTINATION.index(1), ProductFuncCode.PRODUCTS)//
            .withRow3(IdFunction.BUY_DESTINATIONS.index(1), ProductFuncCode.PRODUCTS)//
            .build();
    ...
    private void buildSearchFlights() {
        HomeRuleContent hrc = HomeRuleBuilder.create()//
            ...
            .withRow3(IdFunction.SEARCH_DESTINATIONS.index(3), ProductFuncCode.PRODUCTS)//
            .build();
    ...
    private void buildSearchVacationRentals() {
        ...
        HomeRuleContent hrc = HomeRuleBuilder.create()//
            ...
            .withRow1(IdFunction.LAST_SEARCH_DESTINATIONS.index(1), ProductFuncCode.PRODUCTS)//
            .withRow2(IdFunction.SEARCH_DESTINATIONS.index(1), ProductFuncCode.PRODUCTS)//
            .withRow3(IdFunction.SEARCH_DESTINATIONS.index(2), ProductFuncCode.PRODUCTS)//
            .build();
